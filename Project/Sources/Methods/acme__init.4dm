...
If (ENV_isv17OrAbove)  // use Storage to be "thread-safe" compatible
	...
	If (Storage:C1525.acme=Null:C1517)
		...
		If (BASEcURL_HttpRequest(HTTP GET method:K71:1; $vt_url; ""; ->$vt_publicIpV4)=200)
			//If (HTTP Get($vt_url; $vt_publicIpV4)=200)
		...
		If (BASEcURL_HttpRequest(HTTP GET method:K71:1; $vt_url; ""; ->$vt_publicIpV6)=200)
